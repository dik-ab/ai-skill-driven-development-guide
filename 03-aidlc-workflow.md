...
| Phase | 名称 | 主な成果物 | 人間の関与 |
|---|---|---|---|
| 1 | Context Loading | `phase1-context-summary.md` | 原則なし |
| 2 | Alignment & Implementation Strategy | `phase2-alignment-questions.md`, `phase2-alignment-decisions.md` | 矛盾・未定義がある時だけ |
| 3 | Test Contract Design | `phase3-test-contract.md` | 必須 |
| 4 | Test-First Implementation | `phase4-implementation-plan.md`, 実装、テスト | 実装計画の承認 |
| 5 | Verification & Reconciliation | delta レポート、設計書更新、PR 準備 | レビュー、承認 |
...
ここには事実だけを書きます。リスク評価、実装方針、推奨案は Phase 2 で扱います。
...
## Phase 2: Alignment & Implementation Strategy
...
構造的な方針変更が必要になった場合は、黙って進めず Phase 2 に戻します。
